...
const TS_DEFINITION_GENERATION_FUNCS: &[&dyn Fn() -> Cow<'static, str>] = &[
    &SpotifyId::type_script_ify,
    &SpotifyUri::type_script_ify,
    &SpotifyObjectType::type_script_ify,
    ...
    &Artist::type_script_ify,
    &AlbumSimplified::type_script_ify,
    &TrackLink::type_script_ify,
    &Track::type_script_ify,
    &Item::type_script_ify,
    &TaggedItem::type_script_ify,
    &ItemSearchResponse::type_script_ify,
